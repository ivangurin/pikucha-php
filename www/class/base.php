...
// TODO Написать свой base64
class base
{

    static public function base62_encode($i_number)
    {
        return base::dec2base($i_number, 62);
    }

    static public function dec2base($iNum, $iBase, $iScale = 0)
    { // cope with base 2..62
        $LDEBUG = FALSE;
    ...
    static public function base62_decode($i_code)
    {
        return base::base2dec($i_code, 62);
    }

    static public Function base2dec($sNum, $iBase = 0, $iScale = 0)
    {
        $sChars = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';
        $sResult = '';
    ...
    static public Function base2base($iNum, $iBase, $oBase, $iScale = 0)
    {

        if ($iBase != 10)
            $oNum = self::base2dec($iNum, $iBase, $iScale);
        else
            $oNum = $iNum;
        $oNum = self::dec2base($oNum, $oBase, $iScale);
        return $oNum;
    }
